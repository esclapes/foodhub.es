...
var _basket = require('./components/basket.vue');
...
},{"./components/basket.vue":9,"./vuex/store":13,"vue":4,"vuex":6}],9:[function(require,module,exports){
...
var _basketItem = require('./basketItem.vue');
...
exports.default = {
    vuex: {
        ...
        actions: {
            updateAmount: _actions.updateAmount
        }
    },
    computed: {
    ...
    components: {
        basketItem: _basketItem2.default
    }
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/home/esclapes/Code/foodhub.es/resources/assets/js/components/basket.vue"
...
},{"../vuex/actions":11,"./basketItem.vue":10,"lodash":1,"vue":4,"vue-hot-reload-api":3,"vueify-insert-css":5}],10:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n\n")
'use strict';
...
exports.default = {
    ...
    computed: {
        amount: function amount() {
            var isSelected = _lodash2.default.find(this.selected, { 'id': this.product.id });
            return isSelected ? isSelected.amount : 0;
        }
    },
    methods: {
        increaseAmount: function increaseAmount() {
            var amount = this.amount + this.product.pivot.step_amount;
            this.updateAmount(this.product, amount);
        },
        decreaseAmount: function decreaseAmount() {
            var amount = this.amount - this.product.pivot.step_amount > 0 ? this.amount - this.product.pivot.step_amount : 0;
            this.updateAmount(this.product, amount);
        },
...
},{"../vuex/actions":11,"../vuex/store":13,"lodash":1,"vue":4,"vue-hot-reload-api":3,"vueify-insert-css":5}],11:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
var updateAmount = exports.updateAmount = makeAction('UPDATE_AMOUNT');
...
},{"./store":13,"_process":2,"vuex/logger":7}],13:[function(require,module,exports){
(function (process){
'use strict';
...
var STORAGE_KEY = exports.STORAGE_KEY = 'foodhub_basket';
...
},{"./middleware":12,"_process":2,"lodash":1,"vue":4,"vuex":6}]},{},[8]);
